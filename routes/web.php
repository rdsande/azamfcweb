...
Route::get('post7', function () {
    return view('/posts/viewpost7');
});
Route::get('post8', function () {
    return view('/posts/viewpost8');
});
...
Route::get('post13', function () {
    return view('/posts/viewpost13');
});
Route::get('post14', function () {
    return view('/posts/viewpost14');
});
Route::get('post15', function () {
    return view('/posts/viewpost15');
});
Route::get('post16', function () {
    return view('/posts/viewpost16');
});
Route::get('post17', function () {
    return view('/posts/viewpost17');
});
Route::get('post18', function () {
    return view('/posts/viewpost18');
});
Route::get('post19', function () {
    return view('/posts/viewpost19');
});
...
Route::get('post22', function () {
    return view('/posts/viewpost22');
});
Route::get('post23', function () {
    return view('/posts/viewpost23');
});
Route::get('post24', function () {
    return view('/posts/viewpost24');
});
Route::get('post25', function () {
    return view('/posts/viewpost25');
});
Route::get('post26', function () {
    return view('/posts/viewpost26');
});
//Latest News - View
