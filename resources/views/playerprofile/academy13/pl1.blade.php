        ...
        <div>
            <div class="uk-bg-highlight bg-h-light uk-padding">
                <div class="plyr-container"
                    ...
                    <img src="{{asset('img/players/default2.png')}}" class="playerprfl" loading="lazy" />
                </div>
                <div class="player-no">
                    <!-- <h1>29</h1> -->
                </div>
                ...
                <div class="uk-card uk-card-default uk-card-body inner-info-plyr">
                    <div uk-grid>
                        ...
                        <div class="uk-width-expand@m">
                            ...
                            <span class="title-sm-tp"><img src="https://flagcdn.com/16x12/tz.png"
                                    srcset="https://flagcdn.com/32x24/tz.png 2x, https://flagcdn.com/48x36/tz.png 3x"
                                    width="16" height="12" alt="TZ"> TANZANIA</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-card uk-card-default uk-card-body inner-info-plyr">
                    <div uk-grid>
                        ...
                        <div class="uk-width-expand@m">
                            ...
                            <span class="title-sm-tp">161CM</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-card uk-card-default uk-card-body inner-info-plyr">
                    <div uk-grid>
                        ...
                        <div class="uk-width-expand@m">
                            ...
                            <span class="title-sm-tp">KAJIMA</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <div class="uk-card uk-card-default uk-card-body">
                    <div>
                        ...
                        <div class="uk-grid-small uk-child-width-expand@s uk-text-center" uk-grid>
                            <div uk-lightbox>
                                <a class="uk-button uk-button-default" href="https://youtu.be/zl1KlDd0X2g"
