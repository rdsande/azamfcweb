        ...
        <div>
            <div class="uk-bg-highlight bg-h-light uk-padding">
                <div class="plyr-container" uk-scrollspy="cls: uk-animation-fade; target: .uk-card; delay: 100; repeat: true">
                    <img src="{{asset('img/players/profiles/u20/player9.png')}}" class="playerprfl" loading="lazy" />
                </div>
                <div class="player-no">
                    <!-- <h1>29</h1> -->
                </div>
        ...
        <div>
            <div class="uk-background-primary uk-padding uk-light">
                <div class="player-details-info" uk-scrollspy="cls: uk-animation-fade; target: .uk-card; delay: 100; repeat: true">
                    <h3> GABY JOSEPH FUNDUMO</h3>
                    <h2 class="uk-heading-line uk-text-right uk-text-warning posspan">
                        <span>ATTACHING MIDFIELDER/RIGHT WINGER</span>
                    </h2>
                ...
                <div class="uk-card uk-card-default uk-card-body inner-info-plyr">
                    <div uk-grid>
                        ...
                        <div class="uk-width-expand@m">
                            ...
                            <span class="title-sm-tp">ATTACHING MIDFIELDER/RIGHT WINGER</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-card uk-card-default uk-card-body inner-info-plyr">
                    <div uk-grid>
                        ...
                        <div class="uk-width-expand@m">
                            ...
                            <span class="title-sm-tp">7/29/2005</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-card uk-card-default uk-card-body inner-info-plyr">
                    <div uk-grid>
                        ...
                        <div class="uk-width-expand@m">
                            ...
                            <span class="title-sm-tp">167.7cm</span>
                        </div>
                    </div>
                </div>
            </div>
