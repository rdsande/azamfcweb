        ...
        <div>
            <div class="uk-bg-highlight bg-h-light uk-padding">
                <div class="plyr-container" uk-scrollspy="cls: uk-animation-fade; target: .uk-card; delay: 100; repeat: true">
                    <img src="{{asset('img/players/profiles/player4.png')}}" class="playerprfl" loading="lazy" />
                </div>
                <div class="player-no">
                    <!-- <h1>29</h1> -->
                </div>
                ...
                <div class="uk-card uk-card-default uk-card-body inner-info-plyr">
                    <div uk-grid>
                        ...
                        <div class="uk-width-expand@m">
                            ...
                            <span class="title-sm-tp">FW/ RIGHT WINGER</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-card uk-card-default uk-card-body inner-info-plyr">
                    <div uk-grid>
                        ...
                        <div class="uk-width-expand@m">
                            ...
                            <span class="title-sm-tp"> GAMBIA </span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-card uk-card-default uk-card-body inner-info-plyr">
                    <div uk-grid>
                        ...
                        <div class="uk-width-expand@m plyr-birthdate">
                            ...
                            <span class="title-sm-tp">07.12.1998</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-card uk-card-default uk-card-body inner-info-plyr">
                    <div uk-grid>
                        ...
                        <div class="uk-width-expand@m">
                            ...
                            <span class="title-sm-tp">180CM</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-card uk-card-default uk-card-body inner-info-plyr">
                    <div uk-grid>
                        ...
                        <div class="uk-width-expand@m">
                            ...
                            <span class="title-sm-tp">2023</span>
                        </div>
                    </div>
                </div>
            </div>
