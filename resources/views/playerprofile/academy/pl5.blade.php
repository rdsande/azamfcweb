        ...
        <div>
            <div class="uk-bg-highlight bg-h-light uk-padding">
                <div class="plyr-container"
                    ...
                    <img src="{{asset('img/players/profiles/u20/player18.png')}}" class="playerprfl" loading="lazy" />
                </div>
                <div class="player-no">
                    <!-- <h1>29</h1> -->
                </div>
                ...
                <div class="uk-card uk-card-default uk-card-body inner-info-plyr">
                    <div uk-grid>
                        ...
                        <div class="uk-width-expand@m">
                            ...
                            <span class="title-sm-tp">FULLBACK / RIGHTBACK</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-card uk-card-default uk-card-body inner-info-plyr">
                    <div uk-grid>
                        ...
                        <div class="uk-width-expand@m">
                            ...
                            <span class="title-sm-tp">12/20/2006</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-card uk-card-default uk-card-body inner-info-plyr">
                    <div uk-grid>
                        ...
                        <div class="uk-width-expand@m">
                            ...
                            <span class="title-sm-tp">170.9CM</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <div class="uk-card uk-card-default uk-card-body">
                    <div>
                        ...
                        <div class="uk-grid-small uk-child-width-expand@s uk-text-center" uk-grid>
                            <div uk-lightbox>
                                <a class="uk-button uk-button-default" href="https://youtu.be/W3n1AF0kTyY"
