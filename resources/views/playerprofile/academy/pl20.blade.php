        ...
        <div>
            <div class="uk-bg-highlight bg-h-light uk-padding">
                <div class="plyr-container" uk-scrollspy="cls: uk-animation-fade; target: .uk-card; delay: 100; repeat: true">
                    <img src="{{asset('img/players/profiles/u20/player12.png')}}" class="playerprfl" loading="lazy" />
                </div>
                <div class="player-no">
                    <!-- <h1>29</h1> -->
                </div>
                ...
                <div class="uk-card uk-card-default uk-card-body inner-info-plyr">
                    <div uk-grid>
                        ...
                        <div class="uk-width-expand@m">
                            ...
                            <span class="title-sm-tp">RIGHT/LEFT WINGER</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-card uk-card-default uk-card-body inner-info-plyr">
                    <div uk-grid>
                        ...
                        <div class="uk-width-expand@m">
                            ...
                            <span class="title-sm-tp">10/9/2007</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-card uk-card-default uk-card-body inner-info-plyr">
                    <div uk-grid>
                        ...
                        <div class="uk-width-expand@m">
                            ...
                            <span class="title-sm-tp">160.3CM</span>
                        </div>
                    </div>
                </div>
            </div>
