...
<div class="uk-position-relative uk-margin-medium js-example fixtures-section">
    ...
    <ul uk-tab="swiping: false" role="tablist" class="uk-tab fxture-tabs">
        <li class="uk-active tab-itm" role="presentation"><a href="#" aria-selected="true" role="tab"
                id="uk-tab-5-tab-0" aria-controls="uk-tab-5-tabpanel-0">Fixtures</a></li>
        ...
        <li role="presentation" class="tab-itm"><a href="#" aria-selected="false" role="tab" id="uk-tab-5-tab-2"
                aria-controls="uk-tab-5-tabpanel-2" tabindex="-1">Tables</a></li>
    </ul>
