<div class="afc-carousel">
    <div class="hero-slides">
        ...
        <div class="afc-slide" uk-img="loading: eager"
            style="background-image: url('{{ asset('/img/latest/kiprewinner.jpg')}}');">
            <span class="bgtop"></span>
            <!-- Hero Items Inside Slide -->
            <span class="hero-meta">
                <h1 class="hero-title"> <a href="{{ url('post12')}}"> AZAM FC CLINCHES VICTORY WITH 1-0 WIN OVER SINGIDA
                        FOUNTAIN GATE
                    </a></h1>
                <div class="uk-column-1-2 w-line-separator inner-hero-tags">
                    <p>
                    ...
                    <p>
                        <span class="tag-type-one">
                            <a href="#"><i class="ri-time-line"></i>28/02/2024 </a>
                        </span>
                    </p>
                </div>
            </span>
