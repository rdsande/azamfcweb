        ...
        <div class="inner-fixtures">
            ...
            <div class="teams-inner-container">
                <div class="team-disp-1">
                    <img src="{{ asset('img/teamlogos/simba.png')}}" class="logo-card-item" alt="Team Logo" />
                </div>
...
<li>
    <div class="uk-panel">
        <div class="inner-fixtures">
            ...
            <div class="teams-inner-container">
                <div class="team-disp-1">
                    <img src="{{ asset('img/teamlogos/tabora.png')}}" class="logo-card-item" alt="Team Logo" />
                </div>
                <div class="team-disp-1">
                    <div class="scr-card">
                        <span class="hm-team-score">
...
<li>
    <div class="uk-panel">
        <div class="inner-fixtures">
            ...
            <div class="teams-inner-container">
                <div class="team-disp-1">
                    <img src="{{ asset('img/teamlogos/prison.png')}}" class="logo-card-item" alt="Team Logo" />
                </div>
                <div class="team-disp-1">
                    <div class="scr-card">
                        <span class="hm-team-score">
...
<li>
    <div class="uk-panel">
        <div class="inner-fixtures">
            ...
            <div class="teams-inner-container">
                <div class="team-disp-1">
                    <img src="{{ asset('img/teamlogos/singida.png')}}" class="logo-card-item" alt="Team Logo" />
                </div>
                <div class="team-disp-1">
                    <div class="scr-card">
                        <span class="hm-team-score">
    ...
    <div class="uk-panel">
        <div class="inner-fixtures">
            ...
            <div class="teams-inner-container">
                ...
                <div class="team-disp-1">
                    <img src="{{ asset('img/teamlogos/dodomajiji.png')}}" class="logo-card-item" alt="Team Logo" />
                </div>
            </div>
            <div class="fxture">
                <span class="homteam">
