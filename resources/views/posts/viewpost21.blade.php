...
<div class="page-brdc z-back">
    <div class="uk-background-cover uk-height-large uk-panel uk-flex uk-flex-center uk-flex-middle"
        style="background-image: url('/img/latest/sopuwin.jpg');">
        <h1>
            Azam FC secures crucial win vs KMC FC </h1>
    </div>
</div>
        ...
        <div class="uk-grid-collapse uk-child-width-expand@s uk-text-center" uk-grid>
            ...
            <div class="time-col">
                <div class="uk-padding time-col">
                    <i class="ri-time-line"></i> Published on: 13/05/2024
                </div>
            </div>
...
<div class="uk-section">
    <div class="uk-container uk-container-small">
        <p>Back to winning ways as we defeat KMC to secure three crucial points. On a tough match held at our home
            stadium Azam Complex, the team was able to start off to a good start in the first period of the match
            dominating the play and making many chances. It was until the 15th minute when Bangala scored the fist goal.
            KMC equalised on the 33rd minute before Syllah scored the winning goal on the 38th minute. </p>
    </div>
</div>
