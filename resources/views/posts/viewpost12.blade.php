...
<div class="page-brdc z-back">
    <div class="uk-background-cover uk-height-large uk-panel uk-flex uk-flex-center uk-flex-middle"
        style="background-image: url('/img/latest/kiprewinner.jpg');">
        <h1> Azam FC Clinches Victory with 1-0 Win Over Singida Fountain Gate </h1>
    </div>
</div>
...
<div class="uk-section">
    <div class="uk-container uk-container-small">
        <p class="uk-text-lead">
            Azam FC secured a narrow but crucial 1-0 victory against Singida Fountain Gate. The lone goal, scored in the
            53rd minute by Kipre Jr., sealed the win for Azam FC. A hard-fought match that showcased Azam FC's
            determination to claim three points. </p>
