...
<div class="page-brdc z-back">
    <div class="uk-background-cover uk-height-large uk-panel uk-flex uk-flex-center uk-flex-middle"
        style="background-image: url('/img/latest/mashujaadraw.jpg');">
        <h1> Azam FC and Mashujaa FC Battle to a Draw at Azam Complex </h1>
    </div>
</div>
        ...
        <div class="uk-grid-collapse uk-child-width-expand@s uk-text-center" uk-grid>
            ...
            <div class="time-col">
                <div class="uk-padding time-col">
                    <i class="ri-time-line"></i> Published on: 18/04/2024
                </div>
            </div>
...
<div class="uk-section">
    <div class="uk-container uk-container-small">
        <p> It was an intense encounter at Azam Complex Stadium as Azam FC and Mashujaa FC settled for a thrilling draw
            in a fiercely contested
            match! Both teams showcased their prowess on the pitch, keeping fans on the edge of their seats till the
            final whistle. </p>
    </div>
</div>
